...
from backend_logic.utils import _energy, get_indices_from_dict, _to_numpy, quadro_quadrant_from_azimuth, seven_one_quadrant_from_azimuth, within_margin, azimuth_from_three_energy
import numpy as np
...
def combine_quadro(fl_events, fr_events, rl_events, rr_events, fl_channel, fr_channel, rl_channel, rr_channel):
    if SETUP == "cues":
        ...
        return combine_quadro_azimuth_logic(fl_events, fr_events, rl_events, rr_events, fl_channel, fr_channel, rl_channel, rr_channel)
